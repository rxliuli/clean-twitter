import { g as getDefaultExportFromCjs, _ as __vitePreload } from './_commonjsHelpers-912bb820.js';
...
function createHashHistory$1(options) {
  if (options === void 0) {
    options = {};
  }
  ...
  function getIndexAndLocation() {
    var _parsePath = parsePath$1(window.location.hash.substr(1)),
...
// src/treeMap.ts
function treeMap(nodeList, fn, options) {
  function inner(nodeList2, parentPath) {
    return nodeList2.map((node) => {
...
// src/index.ts
function BaseReactRouter({ history, children }) {
  ...
  return /* @__PURE__ */ React.createElement(Router, { navigator: history, ...state }, children);
}
function isLazy(thing) {
  return typeof thing === "function" && /\(.*\)[ \n]*=>[ \n]*import(.+)/.test(thing.toString());
}
var ReactRouter = (props) => {
  const fallback = reactExports.useMemo(() => props.fallback ?? "...", [props]);
  return /* @__PURE__ */ React.createElement(BaseReactRouter, { history: props.history }, /* @__PURE__ */ React.createElement(Routes, null, treeMap(
    props.routes,
    (item, key) => {
      return /* @__PURE__ */ React.createElement(
        Route,
        {
          key: key.join(","),
          path: item.path,
          element: item.redirect ? /* @__PURE__ */ React.createElement(Navigate, { replace: true, to: item.redirect }) : item.component && (isLazy(item.component) ? /* @__PURE__ */ React.createElement(React.Suspense, { fallback }, React.createElement(React.lazy(item.component))) : React.createElement(item.component)),
...
function createHashHistory() {
  return proxyHistory(createHashHistory$1());
}

const routes = [
  {
    path: "/",
    component: () => __vitePreload(() => import('./OptionView-0a605c72.js'),true?["./OptionView-0a605c72.js","./config-e9f2c23c.js","./browser-polyfill-5a5eabde.js","./_commonjsHelpers-912bb820.js"]:void 0,import.meta.url)
  },
  {
    path: "/callback",
    component: () => __vitePreload(() => import('./CallbackView-f7ad3902.js'),true?["./CallbackView-f7ad3902.js","./_commonjsHelpers-912bb820.js"]:void 0,import.meta.url)
  }
];

function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ReactRouter, { history: createHashHistory(), routes });
}
